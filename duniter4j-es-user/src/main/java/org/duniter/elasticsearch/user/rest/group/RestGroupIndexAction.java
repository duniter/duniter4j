...
public class RestGroupIndexAction extends AbstractRestPostIndexAction {

    @Inject
    public RestGroupIndexAction(Settings settings, RestController controller, Client client,
